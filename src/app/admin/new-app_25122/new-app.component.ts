...
export class NewAppComponent implements OnInit {
  ...
  config:any = {welcome:{button_text:'',welcome_title:'',welcome_desc:'',bg_file_path:''},
                ...
                product:{header_text:'',bg_file_path:''},
                preview:{preview:'',preview_file:''},
                thankyou: {bg_thankyou_file:''},
                ui: {}
               };
  products = [{frontview_file:'',backview_file:'',name:'',canvas_front_width:'',canvas_front_height:'',canvas_back_width:'',canvas_back_height:'',product_id:'',is_active:0}];
  ...
  ngOnInit(): void {
    ...
    this.welcomeForm = this.form.group({
      ...
      welcome_desc: ['',Validators.required],
      radius_topleft: [''],
      radius_topright: [''],
      radius_botleft: [''],
      radius_botright: [''],
